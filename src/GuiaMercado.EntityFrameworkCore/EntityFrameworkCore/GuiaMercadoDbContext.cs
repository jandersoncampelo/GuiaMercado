...
public class GuiaMercadoDbContext :
    AbpDbContext<GuiaMercadoDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public GuiaMercadoDbContext(DbContextOptions<GuiaMercadoDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(GuiaMercadoConsts.DbTablePrefix + "YourEntities", GuiaMercadoConsts.DbSchema);
